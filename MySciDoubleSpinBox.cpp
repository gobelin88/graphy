...
MySciDoubleSpinBox::MySciDoubleSpinBox(QWidget * parent)
...
void MySciDoubleSpinBox::initLocalValues(QWidget *parent)
{
...
int MySciDoubleSpinBox::decimals() const
{
    return dispDecimals;
}

void MySciDoubleSpinBox::setDecimals(int value)
{
    dispDecimals = value;
}

// overwritten virtual function of QAbstractSpinBox
void MySciDoubleSpinBox::stepBy(int steps)
{
    if (steps < 0)
        stepDown();
    else
...
void MySciDoubleSpinBox::stepDown()
{
    QSBDEBUG() << "stepDown()";
    setValue(value()/10.0);
}

void MySciDoubleSpinBox::stepUp()
{
    QSBDEBUG() << "stepUp()";
    setValue(value()*10.0);
}
 ...
 */
QString MySciDoubleSpinBox::textFromValue(double value) const
{
...
double MySciDoubleSpinBox::valueFromText(const QString &text) const
{
    QString copy = text;
...
double MySciDoubleSpinBox::round(double value) const
{
...
// overwritten virtual function of QAbstractSpinBox
QValidator::State MySciDoubleSpinBox::validate(QString &text, int &pos) const
{
...
// overwritten virtual function of QAbstractSpinBox
void MySciDoubleSpinBox::fixup(QString &input) const
{
    input.remove(thousand);
}

// reimplemented function, copied from QDoubleSpinBoxPrivate::isIntermediateValue
bool MySciDoubleSpinBox::isIntermediateValue(const QString &str) const
{
...
QVariant MySciDoubleSpinBox::validateAndInterpret(
    QString &input,
    int &pos,
...
QString MySciDoubleSpinBox::stripped(const QString &t, int *pos) const
{
    QString text = t;
