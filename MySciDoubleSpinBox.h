#ifndef MYSCIDOUBLESPINBOX_H
#define MYSCIDOUBLESPINBOX_H
...
class MySciDoubleSpinBox : public QDoubleSpinBox
{
    Q_OBJECT
    public:
        MySciDoubleSpinBox(QWidget * parent = 0);
