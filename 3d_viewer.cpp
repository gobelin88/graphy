...
ViewerScatter3D::ViewerScatter3D()
{
    ...
    sb_xmin=new QDoubleSpinBox(this);sb_xmin->setRange(-1e100,1e100);sb_xmin->setSingleStep(0.1);
    sb_xmax=new QDoubleSpinBox(this);sb_xmax->setRange(-1e100,1e100);sb_xmax->setSingleStep(0.1);
    sb_ymin=new QDoubleSpinBox(this);sb_ymin->setRange(-1e100,1e100);sb_ymin->setSingleStep(0.1);
    sb_ymax=new QDoubleSpinBox(this);sb_ymax->setRange(-1e100,1e100);sb_ymax->setSingleStep(0.1);
    sb_zmin=new QDoubleSpinBox(this);sb_zmin->setRange(-1e100,1e100);sb_zmin->setSingleStep(0.1);
    sb_zmax=new QDoubleSpinBox(this);sb_zmax->setRange(-1e100,1e100);sb_zmax->setSingleStep(0.1);
...
void ViewerScatter3D::set_data(const Cloud & cloud)
{
...
void ViewerSurface3D::set_data(const Cloud & cloud)
{
    modifier->setData(cloud);
